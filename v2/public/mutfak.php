...
?>
      ...
      <nav class="gun-serit" aria-label="Gün görünümleri">
        ...
        <a class="<?= 'mutfak' === 'mutfak' ? 'active' : '' ?>" href="mutfak.php?date=<?= Helpers::e($date) ?>">Mutfak</a>
        <a class="<?= 'mutfak' === 'sevkiyat' ? 'active' : '' ?>" href="sevkiyat.php?date=<?= Helpers::e($date) ?>">Sevkiyat</a>
      </nav>
      <div class="date-row">
