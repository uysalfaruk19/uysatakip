...
<?php
      ...
      <div class="cardx card-pad">
        ...
        <?php // fable-034c (Ömer): Fatura Kes kaldırıldı; Siparişler → Talepler'de birleşti (tek "Talepler").
              // Erişim kaybı yok — ikisi de moduller.php + FAB menüsünde yaşıyor. Rozet ikisinin toplamı. ?>
        <div class="gt-mods">
          <a class="gt-mod" href="musteriler.php"><i class="bi bi-people"></i>Müşteriler</a>
          <a class="gt-mod" href="talepler.php"><?php $talepRozet = $openReqCount + $pendingCount; if ($talepRozet > 0): ?><span class="gt-mod-dot"><?= $talepRozet ?></span><?php endif; ?><i class="bi bi-chat-left-text"></i>Talepler</a>
